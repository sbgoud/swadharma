...
import { fetchUserCourses } from '../services/supabaseService';
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {courses.map((userCourse) => (
            <Card key={userCourse.id} className="hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">{userCourse.courses.title}</h3>
              <p className="text-gray-600 mb-4">{userCourse.courses.description}</p>
              ...
              <div className="flex items-center text-sm text-gray-600 mb-6">
                ...
                <span>Next test: Tomorrow at 10:00 AM</span>
              </div>
